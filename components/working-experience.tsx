export default function WorkingExperience() {
  return (
    <div>
      <h1 className="text-2xl font-serif mb-8">Working experience</h1>
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-neutral-600">Berbaunesia</p>
              </div>
              <p className="text-neutral-500 text-sm">Feb 2020 - Present</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-neutral-600">Berkendara</p>
              </div>
              <p className="text-neutral-500 text-sm">Feb 2020 - Feb 2023</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-neutral-600">Cukurkuy</p>
              </div>
              <p className="text-neutral-500 text-sm">Feb 2018 - Feb 2020</p>
            </div>
          </div>
        </div>
      </div>
